...
{if $is_connected == true}
	...
	<div class="panel">
		...
		<div class="panel-footer">
			{literal}
				<button id="disconnectFromGetResponse" type="submit" class="btn btn-default pull-right" name="disconnectFromGetResponse"><i class="icon-getresponse icon-unlink"></i> Disconnect</button>
			{/literal}
		</div>
	</div>
	</form>
